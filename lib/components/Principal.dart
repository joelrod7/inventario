...
class _admProgramaState extends State<admPrograma> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Smart Inv"),
        actions: [
          IconButton(
            icon: Icon(Icons.exit_to_app),
            onPressed: () {
              // Lógica para cerrar sesión (si es necesario)
              // Puedes llamar a tu función LoginScreen() o navegar a la pantalla de inicio de sesión
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.grey,
                              offset: Offset(
                                  12.0, 8.0), // Ajusta la posición de la sombra
                              blurRadius:
                                  5.0, // Ajusta el radio de difuminado de la sombra
                            ),
                          ],
                        ),
                        child: Stack(
